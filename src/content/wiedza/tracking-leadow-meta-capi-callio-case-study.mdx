...
<img
  ...
  alt="Workflow n8n Meta CAPI dla Callio: pełen flowchart 5 nodów z Webhook callio-lead, Consent Gate KRYTYCZNE, IF consent granted TRUE, Przygotuj CAPI payload, Meta CAPI Lead z events_received: 1. Dead Letter Queue handler nieaktywny. Real client IP propagated, Event ID dedup OK, total execution 60ms."
  width="1200"
  height="1500"
  loading="lazy"
/>
