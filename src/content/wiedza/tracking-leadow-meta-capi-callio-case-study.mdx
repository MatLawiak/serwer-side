...
<!-- INFOGRAFIKA: Schemat architektury 3-warstwowej. Klient → Cloudflare Worker (first-party trycallio.com/metrics) → n8n na serwerze klienta → Meta CAPI. Pokazać że Browser Pixel i Server CAPI lecą równolegle z tym samym event_id. -->
...
<!-- INFOGRAFIKA: Zrzut z panelu n8n pokazujący sukces execution: Webhook → Consent Gate → Przygotuj CAPI payload → Meta CAPI events_received: 1 → Dead Letter Queue (puste, brak błędu). Strzałki, kolory ok/error. -->
